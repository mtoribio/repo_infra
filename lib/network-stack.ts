...
export class NetworkStack extends Stack {
	...
	constructor(scope: Construct, id: string, props: NetworkStackProps) {
		...
		this.albSG.addIngressRule(ec2.Peer.anyIpv4(), ec2.Port.tcp(80), 'Permitir el acceso a cualquiera en el puerto 80');
		...
		this.containerSG.addIngressRule(this.dbSG, ec2.Port.tcp(3306), 'Permitir el acceso de MySQL al contenedor');
		...
		this.bastionHostSG.addIngressRule(ec2.Peer.anyIpv4(), ec2.Port.tcp(22), 'Permitir el acceso a traves de SSH');
